...
export class Storage {
    constructor(name, state) {
        ...
        this.actions = {};
        this.mutations = {};
        this._mutations(name, this.state, true);
    }
    ...
    addMutations(mutations, flag) {
        if (flag) this.mutations = Object.assign(this.mutations, mutations);
        else
